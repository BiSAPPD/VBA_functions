...
ar_nm_month_qnc_rus = Array("€нварь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сент€брь", "окт€брь", "но€брь", "декабрь")
result = 1
    For f_m = 0 To 11
...
ar_month_rus = Array("€нварь", "февраль", "март", "апрель", "май", "июнь", "июль", "август", "сент€брь", "окт€брь", "но€брь", "декабрь")
...
Select Case Trim(LCase(in_data))
    Case "партнер", "партнЄр", "partner": result = "partner"
